...
// Dummy web server taaki Render ko lage ki kuch chal raha hai
app.get('/', (req, res) => {
    res.send('mParivahan Bot is running 24/7! 🚀');
});
...
const REPO = 'mparivahan-playstore-page';
const RELEASE_TAG = 'v1.0';
const FILE_NAME = 'mParivahan.apk';
// ---------------------
...
bot.onText(/\/start/, (msg) => {
    ...
    bot.sendMessage(chatId, "👋 Welcome bhai! \n\nMain mParivahan APK Updater Bot hoon. Mujhe naya APK file bhejo, main use GitHub pe upload kar dunga aur website automatically update ho jayegi! 🚀");
});
...
// 4. APK file receive karne ka handler
